/*
    ...
    Solution:
    Use queue to store timestamp when hit.
    Dequeue timestamps that earlier than 300 seconds before getHit() timestamp.
...
public class HitCounter {
    ...
    public int getHits(int timestamp) {
        // Dequeue timestamps that more than 300 seconds ago.
        // Stop dequeue when it's empty.
